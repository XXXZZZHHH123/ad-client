...
const Policy = () => {
  return (
    <div className="container">
      <h1>Privacy Policy for Automatic Bookkeeping Software</h1>
      <p>
        <strong>Effective Date:</strong> 28/07/2024{" "}
      </p>

      <h2>Introduction</h2>
      <p>
        Automatic Bookkeeping Software ("we", "us", "our") is committed to
        protecting and respecting your privacy. This Privacy Policy explains how
        we collect, use, disclose, and safeguard your information when you use
        our accounting software ("Service"). Please read this policy carefully
        to understand our views and practices regarding your personal data and
      ...
      <ul>
        ...
        <li>
          ...
          transaction records, payment history, and other related financial
          information.
        </li>
        <li>
          <strong>Technical Information:</strong> IP address, browser type,
          operating system, and other technical data collected through cookies
          and similar tracking technologies.
        </li>
        <li>
          <strong>Usage Data:</strong> Information about how you use our
          Service, such as access times, pages viewed, and other operational
          data.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>To Improve Our Service:</strong> To understand how our users
          interact with our software, to enhance user experience, and to develop
          new features.
        </li>
        <li>
          <strong>To Communicate with You:</strong> To send you updates,
          newsletters, and other information related to your account and our
          Service.
        </li>
        <li>
          <strong>To Ensure Security:</strong> To protect against unauthorized
      ...
      <ul>
        <li>
          <strong>Access:</strong> The right to request copies of your personal
          data.
        </li>
        <li>
          <strong>Rectification:</strong> The right to request correction of any
        ...
        <li>
          <strong>Data Portability:</strong> The right to request transfer of
          your data to another organization.
        </li>
        <li>
          <strong>Objection:</strong> The right to object to our processing of
          your personal data.
        </li>
      </ul>
      <p>
      ...
      <ul>
        <li>
          <strong>Email:</strong> e1133135@u.nus.edu{" "}
        </li>
        <li>
          <strong>Address:</strong> 25 Heng Mui Keng Ter, Singapore 119615{" "}
        </li>
      </ul>
      <p>
